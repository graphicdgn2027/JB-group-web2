    ...
    <section ref={containerRef} className="py-24 bg-white relative overflow-hidden text-foreground">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:w-1/2 w-full flex flex-col">
            <div className="border border-border/30 bg-white p-2 shadow-sm flex-grow flex flex-col min-h-[350px]">
            ...
            <div className="grid grid-cols-2 mt-4 gap-4">
              <div className="border border-border/30 p-5 text-center bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="text-3xl font-black mb-1 text-brand-blue">45+</div>
                <div className="text-xs font-bold tracking-widest text-accent uppercase">Years</div>
              </div>
              <div className="border border-border/30 p-5 text-center bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="text-3xl font-black mb-1 text-brand-blue">6+</div>
                <div className="text-xs font-bold tracking-widest text-accent uppercase">Companies</div>
              </div>
              <div className="border border-border/30 p-5 text-center bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="text-3xl font-black mb-1 text-brand-blue">10+</div>
                <div className="text-xs font-bold tracking-widest text-accent uppercase">Brands</div>
              </div>
              <div className="border border-border/30 p-5 text-center bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="text-3xl font-black mb-1 text-brand-blue">100+</div>
                <div className="text-xs font-bold tracking-widest text-accent uppercase">Employees</div>
              </div>
            </div>
          </motion.div>
