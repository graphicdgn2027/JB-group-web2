      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <motion.div
            ...
            className="lg:w-4/12 w-full flex"
          >
            <div className="border border-border/30 bg-white p-2 shadow-sm w-full flex flex-col">
              <div className="relative overflow-hidden w-full aspect-[8/9]">
                <motion.img
