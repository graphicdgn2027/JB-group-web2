...
const AboutPage = () => {
  return (
    <div className="min-h-screen font-sans bg-background text-foreground selection:bg-brand-red selection:text-white">
      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-brand-blue min-h-[70vh] flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-brand-blue/90 via-brand-blue/50 to-transparent z-0"></div>
        
        <div className="container relative z-10 mx-auto px-6">
          <div className="max-w-4xl border-l-4 border-brand-red pl-8 md:pl-12 py-4">
            ...
            >
              The Story of <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">JB Group</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="text-2xl md:text-3xl font-light text-brand-red uppercase tracking-widest"
            >
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-2/3">
              ...
              <div className="prose prose-lg md:prose-xl max-w-none text-muted-foreground font-light leading-relaxed md:columns-2 gap-12">
                ...
                <p>
                  Our journey has always been about more than products. It is about trust, relationships, reliability and the confidence to grow with Nepal. As we expand into new sectors, we carry forward the entrepreneurial spirit that has defined our family for generations, blending traditional values with modern business practices.
                </p>
              </div>
              ...
              <div className="my-16 py-12 border-t border-b border-brand-red/30 relative">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-foreground leading-snug font-serif italic text-center max-w-3xl mx-auto">
                  "Our journey has always been about more than products. It is about trust, relationships, reliability and the confidence to grow with Nepal."
                </h3>
              </div>
            </div>
